...
export const SCENE_VISUAL_CONTEXT: Record<string, string> = {
  ...
  generator_card_reveal:
    "[SCENE_CONTEXT: You are at the generator. You decide to try turning it on. " +
    "Wait and observe what happens next. Do NOT describe what you see until you receive " +
    "a SCENE_CUE telling you what is happening.]",
