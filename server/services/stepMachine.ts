...
export const STEP_MEDIA_TRIGGER: Record<number, StepMediaEntry> = {
  7:  { mediaId: "tunnel_flashlight_01",  triggerType: "hold_for_input",  timeoutSeconds: 30 },
  9:  { mediaId: "tunnel_generator_01",   triggerType: "chained_auto",    timeoutSeconds: 30 },
  11: { mediaId: "tunnel_generator_01",   triggerType: "chained_auto",    timeoutSeconds: 30 },
  13: { mediaId: "card_joker_01",         triggerType: "hold_for_input",  timeoutSeconds: 30 },
  17: { mediaId: "tunnel_transition_01",  triggerType: "chained_auto",    timeoutSeconds: 30 },
  ...
  24: { mediaId: "park_liminal_01",       triggerType: "chained_auto",    timeoutSeconds: 30 },
  25: { mediaId: "shaft_maintenance_01",  triggerType: "hold_for_input",  timeoutSeconds: 30 },
  26: { mediaId: "elevator_inside_01",    triggerType: "hold_for_input",  timeoutSeconds: 30 },
  27: { mediaId: "elevator_entry_01",     triggerType: "hold_for_input",  timeoutSeconds: 15 },
  28: { mediaId: "elevator_inside_02",    triggerType: "hold_for_input",  timeoutSeconds: 30 },
  29: { mediaId: "hallway_pov_01",        triggerType: "hold_for_input",  timeoutSeconds: 15 },
  31: { mediaId: "hallway_pov_02",        triggerType: "hold_for_input",  timeoutSeconds: 30 },
};
...
const STEP_TRANSITIONS: Record<number, number> = {
  ...
  21: 23, 23: 24, 24: 25, 25: 26, 26: 27, 27: 28, 28: 29, 29: 31,
};
